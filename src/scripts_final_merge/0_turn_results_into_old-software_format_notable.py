...
def main():
    ...
    file_path = PROJECT_ROOT / 'csv_files/amravati/Notable_Survey_Amravati_-_all_versions_-_False_-_2022-07-29-05.csv'
    new_file_path = PROJECT_ROOT / 'src/scripts_final_merge/csv_files/Notable_Survey_5.csv'
    turn_into_old_format(expected_file_path, file_path, new_file_path)

    file_path = PROJECT_ROOT / 'csv_files/aurangabad/Notable_Survey_-_all_versions_-_False_-_2022-04-01-05.csv'
    new_file_path = PROJECT_ROOT / 'src/scripts_final_merge/csv_files/Notable_Survey_6.csv'
    turn_into_old_format(expected_file_path, file_path, new_file_path)
