...
def main(argv):
    ...
    files_with_ids = [
        PROJECT_ROOT / 'src/scripts_final_merge/with_village_id/Sarpanch_Group_merged.csv',
        PROJECT_ROOT / 'csv_files/ahmednagar/Sarpanch Survey_WIDE.csv',
        PROJECT_ROOT / 'csv_files/ahmednagar/Sarpanch Survey_WIDE (1).csv',
        PROJECT_ROOT / 'csv_files/Sarpanch_Survey_Merged_20210824.csv'
    ]
    ...
    for file_suffix in file_suffixes:
        file_path = PROJECT_ROOT / f'src/scripts_final_merge/csv_files/Sarpanch_Survey_{file_suffix}.csv'
