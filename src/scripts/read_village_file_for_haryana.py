...
def main(argv):
    file_path = f'C:/Data/scrap-python-indian-gov/results_wide/results_HARYANA_2020.csv'
    ...
    file_path = f'C:/Data/scrap-python-indian-gov/villages/Haryana_new_incomplete.csv'
    if not os.path.isfile(file_path):
        return
    ...
    with open(file_path, 'r') as original:
        ...
        new_file_path = f'C:/Data/scrap-python-indian-gov/villages/merge_sarpanch_haryana.csv'
