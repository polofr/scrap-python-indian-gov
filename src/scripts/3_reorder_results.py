...
def main(argv):
    ...
    with open(file_path, 'r') as original:
        ...
        new_file_path = f'C:/Data_PoloFr/scrap-python-indian-gov/new_results/results_{state}_{financial_year}.csv'
        with open(new_file_path, 'w', newline='') as modified:
            modified.write('year, state, state_id, district_panchayat, district_panchayat_id, block_panchayat, block_panchayat_id, village_panchayat, village_panchayat_id, village_panchayat_budget_id, category, sctied, sttied, generaltied, totaltied, scuntied, stuntied, generaluntied, totaluntied\n')
            for village in all_villages:
