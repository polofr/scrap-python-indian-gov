    ...
    with open(file_path, "r") as original:
        ...
        for line in lines:
            ...
            village_name = (
                line[5]
                .upper()
                .replace("GRAMPANCHAYAT", "")
                .replace("GRAMPANCHAYT", "")
                .replace(", AKKALKOT", "")
                .replace("(BHOINJE)", "")
                .replace("SAPATNE(BHO)", "SAPATNE (BHOSE)")
                .replace("GRAMPANCHYAT", "")
                .replace("GRAMPANACHAYAT", "")
                .replace("GRAM PANCHAYT", "")
                .replace("GRAMAPANCHAYAT", "")
                .strip()
            )
