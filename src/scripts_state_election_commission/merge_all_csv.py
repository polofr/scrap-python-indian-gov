...
from src.scripts_state_election_commission.config.districts import DISTRICTS
...
def main(argv):
    ...
    for f in listdir(path):
        ...
        district_name = DISTRICTS[district_number]
        with open(file_path, 'r', encoding='utf8') as to_append:
            ...
            for line in lines:
                if is_first is True:
                    is_first = False
                    continue
                new_csv_lines.append(f'{district_number},{district_name},{line}')
    column_names = 'district_id,district,ब्लॉक,ग्राम पंचायत,पद का आरक्षण,उम्मीदवार,पिता/पति,प्रत्याशी का आरक्षण,शैक्षिक योग्यता,लिंग,मोबाइल नं०,प्राप्त वैध मत,प्राप्त मत %,मतदान %,परिणाम'
