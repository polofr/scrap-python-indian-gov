...
def test_problematic_list():
    ...
    script += JsPreparator.get_list_of_panchayats(
        Main.financial_year, Main.state_name, district_code, block_panch_code
    )
...
def test_empty_village():
    panch_request = (
        "getplanView('2220408','28420',5,4,'BHIWANI','DADRI-I','SANKROAD','3');"
    )
...
def test_csv():
    ...
    panch_request = (
        "getplanView('2431296','265924',5,4,'VARANASI','SEVAPURI','MANIYARIPUR','3');"
    )
    script = JsPreparator.get_list_of_panchayat_report(
        Main.financial_year,
        Main.financial_year_plan,
